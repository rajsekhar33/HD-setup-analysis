...
ax.errorbar(k4[1:-10],Ek4[1:-10],yerr=del_Ek4[1:-10],fmt='.-',label=r'$8 \leq |k_{driving}| \leq 10$')
...
plt.ylabel(r'$\rho$(k)')
leg = ax.legend(loc=2, bbox_to_anchor=(0.75, 0.95))
plt.title(r'$\rho$(k) vs k for $256^3$, different $k_{driving}$' )
plt.savefig('Rho_k_diff_k_256.png',dpi=250)

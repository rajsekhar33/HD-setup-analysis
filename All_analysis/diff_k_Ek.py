...
filedir='/mnt/lustre/ug4/ugrajs/cooling/256/'
...
#filedir='/mnt/lustre/ug4/ugrajs/higher_k/256/k6-8/'
filedir='/mnt/lustre/ug4/ugrajs/cooling/higher_k/256/k6-8/'
file=filedir+'pluto_hst.out'
fname = open(file,'rt')
...
ax.errorbar(k4,Ek4,yerr=del_Ek4,fmt='o',label=r'$8 \leq |k_{driving}| \leq 10$')
ax.errorbar(k5,Ek5,yerr=del_Ek5,fmt='*',label=r'$|k_{driving}|=12$')
ax.plot(k1,0.01*k1**(-5/3)*epsilon**(-2/3),'-',label='$k^{-5/3}$')
ax.set_yscale('log')
ax.set_xscale('log')
plt.xlabel('k')
plt.ylabel('E(k)')

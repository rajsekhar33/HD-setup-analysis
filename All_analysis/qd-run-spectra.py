...
wdir=('Q-run/', 'T-runs/Th/', 'B-runs/Bl/', 'B-runs/Bh/', 'B-runs/BDh2/')
labels=('Q', 'Th', 'Bl', 'Bh', 'BDh2')
gamma=5./3.
time_step=0.2
no_bins=200
no_files=5

start=np.array((10., 10.))#, 10., 42., 15.))
...
fit, =ax1.plot(x, 5.e-4*x**(-5./3.), label=r'$k^{-5/3}$', marker="d", markeredgecolor='none', markersize=0.5, linewidth=2.0, color=colors[9])
ax1.set_yscale('log')
ax1.set_xscale('log')
...
plt.savefig('QD-rho-vel-spectra-cool.png',dpi=200)

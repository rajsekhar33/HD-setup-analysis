...
for filenumber in xrange(3,4):
    ...
    Vk=np.sqrt(np.add(np.add(np.square(np.absolute(Vk1)),np.square(np.absolute(Vk2))),np.square(np.absolute(Vk3))))
...
#Curve fitting
    ...
    plt.figure()
    #Here we plot the compensated velocity spectrum, multiplying E(k) with k^(11/6)
    ...
    plt.savefig(filedir+'log_V_k_compensated'+str(filenumber)+'_'+'bin_'+str(int(bin_size*100))+'_'+str(n[0])+'.png')
    plt.savefig('./'+str(n[0])+'/'+str(int(bin_size*100))+'/log_V_k_compensated'+str(filenumber)+'_'+'bin_'+str(int(bin_size*100))+'_'+str(n[0])+'.png')
    
    #This is to plot the original velocity spectrum, without any compensation
    plt.figure()
    ...
    plt.title('V(k) vs k for t='+str(filenumber)+' '+'bin size = '+str(bin_size)+', size =' +str(n[0])+'*'+str(n[1])+'*'+str(n[2]))
    plt.savefig(filedir+'log_V_k'+str(filenumber)+'_'+'bin_'+str(int(bin_size*100))+'_'+str(n[0])+'.png')
    plt.savefig('./'+str(n[0])+'/'+str(int(bin_size*100))+'/log_V_k'+str(filenumber)+'_'+'bin_'+str(int(bin_size*100))+'_'+str(n[0])+'.png')

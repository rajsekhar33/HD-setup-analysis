 ...
 *********************************************************************** */
{
  ...
  if (g_stepNumber==0) {
    ...
    fprintf(hist_file,"#time g_dt mass TE KE1 KE2 KE3 MOM1 MOM2 MOM3 Net_cool Net_heating \n ");
  }
...
//    dvol = grid[IDIR].dV*grid[JDIR].dV*grid[KDIR].dV;
  ...
  #endif
  fprintf(hist_file,"%20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e %20.10e\n ", g_time, g_dt, g_mass, g_TE, g_KE1, g_KE2, g_KE3, g_mom1, g_mom2, g_mom3, g_tot_cool, g_tot_heat);//If you are calculating epsilon from g_tot_heat, you should divide it mass of the domain, which is 1.0 here.
  fclose(hist_file);
  #ifdef PARALLEL
  }
  #endif

...
#ax.errorbar(k4,Ek_comp4,yerr=del_Ek_comp4,fmt='o-',label=r'$\nu=0.001$')
ax.set_yscale('log')
ax.set_xscale('log')
plt.xlabel('k')
...
plt.savefig('E_k_compensated_diff_viscosity_256.png')
...
#ax.errorbar(k4,Ek4,yerr=del_Ek4,fmt='o-',label=r'$\nu=0.001$')
ax.plot(k1,Ek1,'*-',label=r'$\nu=0.0$')
ax.plot(k2,Ek2,'d-',label=r'$\nu=0.0001$')
...
plt.savefig('E_k_diff_viscosity_256.png')

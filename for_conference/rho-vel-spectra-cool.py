...
ratio_legend=ax2.legend(loc='lower right',  ncol=5, fancybox=True, bbox_to_anchor=(1., -0.02), frameon=True, framealpha=0.5, fontsize=20)
ax2.add_artist(ratio_legend)
fit, =ax2.plot(x, 2.e-3*x**(3./2.), label=r'$k^{3/2}$', marker="d", markeredgecolor='none', markersize=0.5, linewidth=2.0, color=colors[9])

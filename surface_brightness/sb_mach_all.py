...
#       fig, ax = plt.subplots(1)
	...
	if(i1!=4):
		...
		perturb2[i1], =ax.plot(data[:,2][int(start_time[i1]/step_size):del_R.size], del_R[int(start_time[i1]/step_size):], label=labels[i1], color=colors[i1+3], marker=".", markeredgecolor='none', markersize=8., linewidth=1.)

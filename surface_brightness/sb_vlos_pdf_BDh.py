...
sb_legend1=ax.legend(handles=sb_vlos[::2], loc='upper left', bbox_to_anchor=(0.0, 1.0), ncol=1, fontsize=20.)
ax.add_artist(sb_legend1)
sb_legend1.get_frame().set_alpha(0.)

sb_legend2=ax.legend(handles=sb_vlos[1::2], loc='upper right', bbox_to_anchor=(1.0, 1.0), ncol=1, fontsize=20.)

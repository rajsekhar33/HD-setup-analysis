...
wdir=('turb_perturb/DBh2e-1/F1e-1/', 'turb_perturb/DBh2e-1/F5e-1/', 'turb_perturb/DBh2e-1/F8e-1/')
...
"""
step_size=0.2
end=np.array((31.6, 31., 27.8))
start_time=np.array((6.4, 8.6, 14.6))
...
ax.set_xlim(-1e3, 1e3)
ax.set_ylim(0., 3e-3)
plt.savefig('sb-vlos-pdf-BDh2.png',dpi=250)
ax.set_yscale('log')
ax.set_ylim(1e-5, 1e-2)
plt.savefig('sb-vlos-pdf-log-BDh2.png',dpi=250)
